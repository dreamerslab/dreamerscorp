...
class WP_Widget_Archives extends WP_Widget {
	...
	function WP_Widget_Archives() {
		$widget_ops = array('classname' => 'widget-archive', 'description' => __( 'A monthly archive of your blog&#8217;s posts') );
...
class WP_Widget_Recent_Posts extends WP_Widget {
	...
	function WP_Widget_Recent_Posts() {
		$widget_ops = array('classname' => 'widget-recent-entries', 'description' => __( "The most recent posts on your blog") );
...
class WP_Widget_Recent_Comments extends WP_Widget {
	...
	function WP_Widget_Recent_Comments() {
		$widget_ops = array('classname' => 'widget-recent-comments', 'description' => __( 'The most recent comments' ) );
